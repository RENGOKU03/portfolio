...
const Landing = () => {
  return (
    <div className=" bg-[rgb(240,220,203)] p-5 sm:p-10 lg:px-14">
      <div className="md:flex justify-center">
        <div className="md:w-1/2 self-center">
          <div className="pt-10 ">
            <span className="text-xs 3xs:text-lg lg:text-xl bg-[#e3b58b] p-2 rounded-md font-bold">
              <span className="text-xl lg:text-2xl">👋</span> Hello All
            </span>
          </div>
          <div className="text-2xl 3xs:text-4xl lg:text-5xl font-bold text-[#191919] pt-5 tracking-widest whitespace-nowrap">
